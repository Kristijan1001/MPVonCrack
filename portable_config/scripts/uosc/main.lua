...
Documentation_ https://github.com/hooke007/mpv_PlayKit/discussions/186

Minimalist design-driven multi-functional interface script group, compatible with thumbfast thumbnail engine
]]
...
-- Default contents of the context menu
...
function update_display_dimensions()
	...
	-- Here is the first place display resolution info can be obtained
...
-- Automatically pop up context menu when idle
